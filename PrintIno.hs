...
instance Print Program where
  prt i e = case e of
    ProgramS topdefs -> prPrec i 0 (concatD [prt 0 topdefs])
...
instance Print Arg where
  prt i e = case e of
    ValueArg type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
...
instance Print Block where
  prt i e = case e of
    BlockS stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])
...
instance Print Stmt where
  prt i e = case e of
    ...
    AssArrTupl id ns expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 ns, doc (showString "]"), doc (showString "="), prt 0 expr, doc (showString ";")])
    ...
    For type_ id expr1 expr2 expr3 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id, doc (showString "="), prt 0 expr1, doc (showString ";"), prt 0 expr2, doc (showString ";"), prt 0 expr3, doc (showString ")"), prt 0 stmt])
...
instance Print Item where
  prt i e = case e of
    ...
    InitArr id type_ ns -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 ns, doc (showString "]")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Type where
  prt i e = case e of
    ...
    Tuple types -> prPrec i 0 (concatD [doc (showString "tuple"), doc (showString "<"), prt 0 types, doc (showString ">")])
    Fun typeas type_ -> prPrec i 0 (concatD [doc (showString "("), prt 0 typeas, doc (showString ":"), prt 0 type_, doc (showString ")")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print TypeA where
  prt i e = case e of
    TypeArg type_ -> prPrec i 0 (concatD [prt 0 type_])
    TypeArgR type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Expr where
  prt i e = case e of
    ...
    EArr id ns -> prPrec i 6 (concatD [prt 0 id, doc (showString "["), prt 0 ns, doc (showString "]")])
    EMakeTuple types exprs -> prPrec i 6 (concatD [doc (showString "make_tuple"), doc (showString "<"), prt 0 types, doc (showString ">"), doc (showString "("), prt 0 exprs, doc (showString ")")])
    EMethod id1 id2 -> prPrec i 6 (concatD [prt 0 id1, doc (showString "."), prt 0 id2])
    ELambda args type_ stmt -> prPrec i 6 (concatD [doc (showString "lambda"), doc (showString "("), prt 0 args, doc (showString ":"), prt 0 type_, doc (showString ")"), prt 0 stmt])
